...
//  Mind Reset
//
//  Objective: Pop-up view for users to add habits to their collection.
//
...
struct AddHabitView: View {
    ...
    private enum Field: Hashable { case title, description, goal, customMetric }
    ...
    private var isFormValid: Bool {
        ...
        !habitGoal.isEmpty &&
        (selectedMetricCategory != .custom ||
         !customMetricTypeInput.trimmingCharacters(in: .whitespacesAndNewlines).isEmpty)
    }
    ...
    var body: some View {
        NavigationStack {
            ZStack {
                ...
                .scrollDismissesKeyboard(.immediately)   // ← dismiss keyboard on drag
            }
